export default function Footer() {
  return (
    <footer className="bg-[#2d1f5e] text-white/60 text-sm text-center py-8 px-4">
      ...
      <p>&copy; {new Date().getFullYear()} Ann&apos;s Flowers &amp; Gifts of Ashland. All rights reserved.</p>
      <p className="mt-1">
